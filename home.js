function submitForm() {
    ...
    const options = {
        ...
        body: '{"status":0,"legacyContactKey":"SW5kaXZpZHVhbAkyMzEwMzEyNTIwMDAzOTA5NTEzNDBDCTA=","name":"test","startDate":"11-11-2012","description":"desc","cost":10000}'
      };
      
      fetch('https://api.maximizer.com/ferret/v1/opportunities', options)
